...
alpine: ## Build Alpine images
	...
	@make ${COMMAND} GIT_HASH=${GIT_HASH} ALPINE_VERSION=3.16.7 TAG=3.16
	@make ${COMMAND} GIT_HASH=${GIT_HASH} ALPINE_VERSION=3.17.5 TAG=3.17
	@make ${COMMAND} GIT_HASH=${GIT_HASH} ALPINE_VERSION=3.18.3 TAG=3.18 LATEST=true